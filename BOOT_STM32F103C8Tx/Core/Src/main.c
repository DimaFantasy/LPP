...
// ============================================================================
const uint32_t BOOT_KEY0   __attribute__((section(BOOT_KEY0_SECTION)))   = BOOT_SIG_KEY0;
const uint32_t BOOT_KEY1   __attribute__((section(BOOT_KEY1_SECTION)))   = BOOT_SIG_KEY1;
const uint32_t BOOT_KEY2   __attribute__((section(BOOT_KEY2_SECTION)))   = BOOT_SIG_KEY2;
const uint32_t BOOT_KEY3   __attribute__((section(BOOT_KEY3_SECTION)))   = BOOT_SIG_KEY3;

const uint32_t BOOT_VER_F  __attribute__((section(BOOT_VER_F_SECTION)))  = BOOT_VERSION;
