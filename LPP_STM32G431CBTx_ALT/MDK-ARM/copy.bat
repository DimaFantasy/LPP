...
set "source=%batdir%LPP_STM32G431CBTx_ALT\LPP_STM32G431CBTx_ALT.hex"
:: Целевая папка: подняться на 3 уровня до \, потом в DELPHI_PROJEKT\...
set "destination=%batdir%..\..\..\DELPHI_PROJEKT\XE7\bin\update\STM32G431CBTx_ALT\!STM32G431CBTx_ALT_app.hex"
