...
## 🧪 Заметка после первых экспериментов

При размещении драйвера на основной плате ёмкость затвора и очень крутые фронты «хорошего» драйвера создают сильные помехи, которые наводятся в FFC-шлейф и мешают работе USB. Проблему сглаживает резистор ~10 Ω в цепи затвора, но это скорее костыль, поэтому в следующих ревизиях драйвер планируется располагать непосредственно на каретке. Хотя и так работает прекрасно.
